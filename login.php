...
<div id="login">
  <form id="form1" name="form1" method="post" action="login_ver.php">
    <table width="500" height="200" border="0" cellpadding="0" cellspacing="1" id="t_login">
      <tr>
        <td height="38" colspan="2" align="center" bgcolor="#C4D7FF">学生登陆</td>
      </tr>
      <tr>
        <td rowspan="3" align="center" bgcolor="#FFFFFF"><table width="190" height="112" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="115" rowspan="3" align="center">
            
            <img src="pics/login_t.jpg" width="85" height="106" />
            </td>
            <td width="75" height="31" align="center">学　号：</td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <a href="find_pw.php?r=2">忘记密码</a></td>
      </tr>
      <tr>
