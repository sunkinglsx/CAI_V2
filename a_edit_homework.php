...
<script >
    ...
    <tr>
      ...
      <td>  
      <?php 	//后缀名转化处理
	  	$ext_list=array('php','txt','html','doc','docx','zip','rar','pdf');
    ...
    <tr>
      <td height="32" align="center" bgcolor="#DADFED">是否需要查重</td>
      <td><p>
        <label>
          <input type="radio" name="needcheck" value="1" id="needcheck_0" <?php if($arr_w['needcheck']==1) echo "checked='checked'";?> />
          是</label>
        <label>
          <input name="needcheck" type="radio" id="needcheck_1" value="0"  <?php if($arr_w['needcheck']==0) echo "checked='checked'";?>/>
          否</label>
      </p></td>
    </tr>
    <tr>
      <td height="35" align="center" bgcolor="#D5F4F4">参考答案</td>
    ...
    <tr>
      <td height="33" align="center" bgcolor="#EBEBEB">参考讲义</td>
    ...
    <tr>
      <td height="24" colspan="2" bgcolor="#D5F4F4">题目描述</td>
    </tr>
    <tr>
